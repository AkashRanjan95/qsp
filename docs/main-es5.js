(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RegisterComponent = /** @class */ (function () {
                ...
                RegisterComponent.prototype.getTitle = function (event) {
                    console.log('helllo');
                };
                RegisterComponent.prototype.clickEvent = function (event) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
            /* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
            var EmploginComponent = /** @class */ (function () {
                function EmploginComponent() {
                }
                EmploginComponent.prototype.ngOnInit = function () {
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserComponent = /** @class */ (function () {
                ...
                UserComponent.prototype.clickEvent = function (event) {
                    alert("hello akki!");
                };
                ;
                UserComponent.prototype.hoverEvent = function (event) {
                    console.log(event);
                };
                ;
                UserComponent.prototype.typeEvent = function (event) {
                    if (event.keyCode === 13) {
                        console.log(event.target.value);
                    } //this is javascript way & also event filtering is included
                };
                UserComponent.prototype.angularWayTypeEvent = function (event) {
                    console.log(event.target.value);
                };
                UserComponent.prototype.enterEmail = function (email) {
                    console.log('my email addres is', email);
                };
                UserComponent.prototype.checkUsername = function (event) {
                    console.log('my name is', event.target.value);
                };
                UserComponent.prototype.addEmp = function () {
                ...
                UserComponent.prototype.removeEmp = function (emp) {
                    var index = this.employee.indexOf(emp); //checking index
